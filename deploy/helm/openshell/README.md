...
| supervisor.sidecar.upstreamCaConfigMapName | string | `""` | Optional ConfigMap in the sandbox namespace whose ca-certificates.crt key is mounted read-only into network sidecars for upstream TLS trust. |
